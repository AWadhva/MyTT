...
{
    class MediaOpReqAdjustmentCSCUsingCash : MediaOpReqPreRegisteration
    {
        public MediaOpReqAdjustmentCSCUsingCash(MainTicketingRules ticketingRules, Int64 snum, LogicalMedia mediaDataPriorToOperation, AdjustmentParams opParsXml) :
