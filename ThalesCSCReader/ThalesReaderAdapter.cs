...
{
    public class ThalesReaderAdapter
    {
#if WindowsCE
       ...
       public extern static short sSmartFieldEx(
        ...
        public extern static short sCSCReaderGetReaderVersionEx(
                int phRw, out short readerType );

        [DllImport("ThalesCscApi.dll", SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        public extern static short sCscInstallFileEx(
               int phRw,
