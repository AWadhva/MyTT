  ...
  public  class CBBAPI
    {
        ...
        public bool SendDESFireCmd(byte byCmd, byte[] abyData, byte[] abyResultBuf)
        {
        ...
        public bool ICPowerOn(bool bIsSAM, byte[] pbyInputParam, byte[] pbyResultBuf)
        {
        ...
        // Sends a command to a reader
        public bool SendSAMCommand(bool bIsSAM, byte[] abyInputData)
        {
